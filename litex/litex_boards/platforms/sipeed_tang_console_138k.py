...
_io = [
    ...
    ("rst_n",  0, Pins("AA13"), IOStandard("LVCMOS33"), Misc("PULL_MODE=UP")), #EX_KEY.0
    ...
    ("ddram", 0,
        ...
        Subsignal("dm",      Pins("AA4 V7 T6 W1"),   IOStandard("SSTL15"), Misc("DRIVE=12")),
        Subsignal("dq",      Pins(
        ...
        Subsignal("dqs_p",   Pins("Y3 V9 W6 R3"),    IOStandard("SSTL15D"), Misc("DRIVE=8")),
        Subsignal("dqs_n",   Pins("AA3 V8 W5 R2"),   IOStandard("SSTL15D"), Misc("DRIVE=8")),
...
class Platform(GowinPlatform):
    ...
    def __init__(self, dock="standard", toolchain="gowin"):
        GowinPlatform.__init__(self, "GW5AST-LV138PG484AC1/I0", _io, _connectors, toolchain=toolchain, devicename="GW5AST-138C")
